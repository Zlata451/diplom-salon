...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold text-gray-800">
            ✏️ Редагувати: <?php echo e($about->section === 'intro' ? 'Дипломне пояснення' : 'Про салон'); ?>
        ...
        <form action="<?php echo e(route('admin.about.update', $about->id)); ?>" method="POST">
            ...
            <div class="mb-4">
                <label for="content" class="block text-sm font-medium text-gray-700">
                    <?php echo e($about->section === 'intro' ? 'Текст дипломного пояснення' : 'Текст про салон'); ?>:
                </label>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>💾 Зберегти <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
