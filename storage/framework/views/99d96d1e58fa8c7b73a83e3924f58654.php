...
<?php endif; ?>
    ...
    <div class="mt-6 text-center">
        <a href="<?php echo e(route('register')); ?>" class="underline text-sm text-pink-600 hover:text-pink-800">
            Ще не зареєстровані? <strong>Реєстрація</strong>
        </a>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\diplom-salon\resources\views/auth/login.blade.php ENDPATH**/ ?>